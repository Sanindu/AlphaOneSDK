const keyboard_english_housenumber = `
...
<div class="container-fluid outerWrapper container-keybord-keypad">
    ...
    <div class="row">
        <div class="col container-keybord-key"><button type="button" onclick="keyboardNICButtonClick(this)" class="btn btn-primary btn-block btn-keybord">-</button></div>
        <div class="col container-keybord-key"><button type="button" onclick="keyboardNICButtonClick(this)" class="btn btn-primary btn-block btn-keybord">/</button></div>
        <div class="col container-keybord-key"><button type="button" onclick="keyboardNICButtonClick(this)" class="btn btn-primary btn-block btn-keybord">.</button></div>
        <div class="col container-keybord-key"><button type="button" onclick="keyboardNICButtonClick(this)" class="btn btn-primary btn-block btn-keybord">,</button></div>
        <div class="col container-keybord-key"><button type="button" onclick="keyboardNICButtonClick(this)" class="btn btn-primary btn-block btn-keybord">'</button></div>
    ...
    <div class="row">
        <div class="col container-keybord-key"><button type="button" onclick="keyboardNICButtonClick(this)" class="btn btn-primary btn-block btn-keybord">A</button></div>
        <div class="col container-keybord-key"><button type="button" onclick="keyboardNICButtonClick(this)" class="btn btn-primary btn-block btn-keybord">B</button></div>
        <div class="col container-keybord-key"><button type="button" onclick="keyboardNICButtonClick(this)" class="btn btn-primary btn-block btn-keybord">C</button></div>
        <div class="col container-keybord-key"><button type="button" onclick="keyboardNICButtonClick(this)" class="btn btn-primary btn-block btn-keybord">D</button></div>
        <div class="col container-keybord-key"><button type="button" onclick="keyboardNICButtonClick(this)" class="btn btn-primary btn-block btn-keybord">E</button></div>
        <div class="col container-keybord-key"><button type="button" onclick="keyboardNICButtonClick(this)" class="btn btn-primary btn-block btn-keybord">F</button></div>
        <div class="col container-keybord-key"><button type="button" onclick="keyboardNICButtonClick(this)" class="btn btn-primary btn-block btn-keybord">G</button></div>        
    </div>
    <div class="row">
