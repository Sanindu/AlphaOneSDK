const keyboard_tamil_profession = `
<div class="card">
...
<div id="keybordWindow">
    <div>
        <div class="container-fluid outerWrapper container-keybord-keypad">     
            ...
            <div class="row">
                <div class="col container-keybord-key"><button type="button" onclick="keyboardTitleButtonClick(this)" class="btn btn-primary btn-block btn-keybord">பொறியாளர்</button></div>
                ...
                <div class="col container-keybord-key"><button type="button" onclick="keyboardTitleButtonClick(this)" class="btn btn-primary btn-block btn-keybord">வணிகர்</button></div>
            </div>
 
            <div class="row">
                <div class="col container-keybord-key"><button type="button" onclick="keyboardTitleButtonClick(this)" class="btn btn-primary btn-block btn-keybord">ஒப்பந்தக்காரர்</button></div>
                <div class="col container-keybord-key"><button type="button" onclick="keyboardTitleButtonClick(this)" class="btn btn-primary btn-block btn-keybord">ஆசிரியர்</button></div>
            </div>
